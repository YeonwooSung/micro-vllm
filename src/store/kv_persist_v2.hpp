...
// COLIKV2 KV8 e4m3 on-disk KV cache. Little-endian host. Not thread-safe.
// Public records are F32 (same shape as KvPersistRecord); L/R are quantized on
// append and dequantized on load. DSA I stays F32.
class KvPersistV2 {
public:
    ...
    KvPersistV2() = default;
    KvPersistV2(const KvPersistV2 &) = delete;
    KvPersistV2 &operator=(const KvPersistV2 &) = delete;
    KvPersistV2(KvPersistV2 &&) = delete;
    KvPersistV2 &operator=(KvPersistV2 &&) = delete;
    ~KvPersistV2();
